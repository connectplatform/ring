...
export class BackendSelector implements IDatabaseService {
  ...
  private initializeRoutes(routes: BackendRoute[]): void {
    ...
    const defaultRoutes: BackendRoute[] = [
      ...
      { collection: 'project_wallet_contacts', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'project_wallets', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      ...
      { collection: 'news_submission_audit', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'payment_transactions', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'analytics_events', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'web_vitals', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'analytics_errors', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      ...
      { collection: 'nft_gate_purchases', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'settlements', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      { collection: 'stock_movements', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      ...
      { collection: 'user_content_interactions', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
      ...
      { collection: 'push_subscriptions', backend: 'postgresql', priority: BackendPriority.PRIMARY, syncEnabled: false },
