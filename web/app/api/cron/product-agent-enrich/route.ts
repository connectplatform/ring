/**
 * Cron: nightly WebConductor productAgent enrich for stale/missing knowledge.
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('Cron: product-agent-enrich failed:', error)
    return NextResponse.json(
