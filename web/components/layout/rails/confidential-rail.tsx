...
export interface ConfidentialSidebarContentProps {
  locale: Locale
...
/**
 * Extracted Confidential right-rail content (SSOT for confidential sidebar).
 * Used by confidential-wrapper via RingRightRailLayout.
 */
export function ConfidentialSidebarContent({
  locale,
  contentType = 'entities',
  onNavigate,
}: ConfidentialSidebarContentProps) {
      ...
      <Card className="border-red-200 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900">
        ...
        <CardContent className="space-y-3">
          ...
          <Button
            ...
            size="sm"
            className="w-full"
            onClick={() => handleNavigate(`${ROUTES.DOCS(locale)}/confidential`)}
          >
