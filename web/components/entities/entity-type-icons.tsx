...
const TYPE_VISUALS: Record<string, TypeVisual> = {
  ...
  // Civic & Municipal (mvm-city / news-station)
  localGovernment: { icon: Landmark, color: 'stone', bgColor: 'bg-stone-600', textColor: 'text-stone-700' },
  municipalUtility: { icon: Wrench, color: 'blue', bgColor: 'bg-blue-600', textColor: 'text-blue-700' },
  hospital: { icon: HeartPulse, color: 'rose', bgColor: 'bg-rose-600', textColor: 'text-rose-700' },
  clinic: { icon: Stethoscope, color: 'teal', bgColor: 'bg-teal-600', textColor: 'text-teal-700' },
  pharmacy: { icon: Pill, color: 'emerald', bgColor: 'bg-emerald-600', textColor: 'text-emerald-700' },
  school: { icon: GraduationCap, color: 'indigo', bgColor: 'bg-indigo-600', textColor: 'text-indigo-700' },
  kindergarten: { icon: Baby, color: 'amber', bgColor: 'bg-amber-600', textColor: 'text-amber-700' },
  university: { icon: GraduationCap, color: 'violet', bgColor: 'bg-violet-600', textColor: 'text-violet-700' },
  library: { icon: BookOpen, color: 'sky', bgColor: 'bg-sky-600', textColor: 'text-sky-700' },
  culturalCenter: { icon: Palette, color: 'fuchsia', bgColor: 'bg-fuchsia-600', textColor: 'text-fuchsia-700' },
  theater: { icon: Clapperboard, color: 'purple', bgColor: 'bg-purple-600', textColor: 'text-purple-700' },
  museum: { icon: Landmark, color: 'amber', bgColor: 'bg-amber-600', textColor: 'text-amber-700' },
  sportsComplex: { icon: Trophy, color: 'orange', bgColor: 'bg-orange-600', textColor: 'text-orange-700' },
  parkRecreation: { icon: Trees, color: 'emerald', bgColor: 'bg-emerald-600', textColor: 'text-emerald-700' },
  localProducer: { icon: Wheat, color: 'lime', bgColor: 'bg-lime-600', textColor: 'text-lime-700' },
  craftArtisan: { icon: Hammer, color: 'amber', bgColor: 'bg-amber-600', textColor: 'text-amber-700' },
  localBusiness: { icon: Store, color: 'cyan', bgColor: 'bg-cyan-600', textColor: 'text-cyan-700' },
  foodHoreca: { icon: Utensils, color: 'orange', bgColor: 'bg-orange-600', textColor: 'text-orange-700' },
  ngo: { icon: Heart, color: 'pink', bgColor: 'bg-pink-600', textColor: 'text-pink-700' },
  veteransCenter: { icon: Medal, color: 'yellow', bgColor: 'bg-yellow-600', textColor: 'text-yellow-700' },
  youthHub: { icon: Sprout, color: 'emerald', bgColor: 'bg-emerald-600', textColor: 'text-emerald-700' },
