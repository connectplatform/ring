...
/**
 * Captures clicks on real navigation anchors inside the desktop sidebar shell
 * so the Admin supermenu closes for logo / primary / identity / utility links.
 * Buttons (theme, locale, resize, Admin toggle) are intentionally ignored.
 */
