...
/**
 * Community Layer1 — no Ringdom distribution CRM (project_order / my-jobs).
 * Empire overlay: ring-platform-org/web/components/navigation/navigation.tsx
...
export default function Navigation() {
  ...
  // Community Layer1 — store orders only (no project_order / my-jobs)
  const userMenuItems = [
    {
