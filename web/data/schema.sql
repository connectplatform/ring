...
COMMENT ON TABLE public.push_subscriptions IS 'RFC Web Push subscriptions — JSONB; dual-stack beside fcm_tokens';
...
--
-- Name: idx_docs_article_enrichment_content_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_article_enrichment_content_hash ON public.docs_article_enrichment USING btree (((data ->> 'contentHash'::text)));


--
-- Name: idx_docs_article_enrichment_data_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_article_enrichment_data_gin ON public.docs_article_enrichment USING gin (data);


--
-- Name: idx_docs_article_enrichment_locale; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_article_enrichment_locale ON public.docs_article_enrichment USING btree (((data ->> 'locale'::text)));


--
-- Name: idx_docs_article_enrichment_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_article_enrichment_slug ON public.docs_article_enrichment USING btree (((data ->> 'slug'::text)));
...
--
-- Name: idx_generated_docs_media_content_hash; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_generated_docs_media_content_hash ON public.generated_docs_media USING btree (((data ->> 'contentHash'::text)));


--
-- Name: idx_generated_docs_media_data_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_generated_docs_media_data_gin ON public.generated_docs_media USING gin (data);


--
-- Name: idx_generated_docs_media_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_generated_docs_media_kind ON public.generated_docs_media USING btree (((data ->> 'kind'::text)));


--
-- Name: idx_generated_docs_media_locale; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_generated_docs_media_locale ON public.generated_docs_media USING btree (((data ->> 'locale'::text)));


--
-- Name: idx_generated_docs_media_slug; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_generated_docs_media_slug ON public.generated_docs_media USING btree (((data ->> 'slug'::text)));
...
--
-- Name: idx_push_subscriptions_data_gin; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_subscriptions_data_gin ON public.push_subscriptions USING gin (data);


--
-- Name: idx_push_subscriptions_data_is_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_subscriptions_data_is_active ON public.push_subscriptions USING btree ((((data ->> 'isActive'::text))::boolean));


--
-- Name: idx_push_subscriptions_data_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_push_subscriptions_data_user_id ON public.push_subscriptions USING btree (((data ->> 'userId'::text)));
...
CREATE UNIQUE INDEX idx_push_subscriptions_endpoint ON public.push_subscriptions USING btree (((data ->> 'endpoint'::text)));


--
-- Name: idx_push_subscriptions_user_device; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_push_subscriptions_user_device ON public.push_subscriptions USING btree (((data ->> 'userId'::text)), ((data ->> 'deviceFingerprint'::text)));
...
--
-- Name: docs_article_enrichment update_docs_article_enrichment_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_docs_article_enrichment_updated_at BEFORE UPDATE ON public.docs_article_enrichment FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: generated_docs_media update_generated_docs_media_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_generated_docs_media_updated_at BEFORE UPDATE ON public.generated_docs_media FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
INSERT INTO public.schema_versions (version, description, applied_at, applied_by) VALUES ('4.1.0', 'Flattened SSOT: schema.sql absorbs migrations through 043 + 2026-06-13 notification_preferences', '2026-08-06 14:54:52.780787+03', 'ring_user');
INSERT INTO public.schema_versions (version, description, applied_at, applied_by) VALUES ('044', 'store_user_carts: authenticated buyer cart mirror for agent commerce', '2026-08-06 14:54:53.63468+03', 'ring_user');
INSERT INTO public.schema_versions (version, description, applied_at, applied_by) VALUES ('4.0.4-push-subscriptions-jsonb', 'push_subscriptions JSONB for RFC web-push dual-stack', '2026-08-06 14:54:53.693803+03', 'ring_user');
