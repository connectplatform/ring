-- Create vendor profile for automart@gmail.com (Ring Portal Store)
-- NOTE: vendor_profiles uses standard JSONB model (id, data, created_at, updated_at)
INSERT INTO vendor_profiles (id, data, created_at, updated_at)
VALUES (
  'vendor_ring_portal_store',
  '{
    "entityId": "entity_ring_portal_store",
    "userId": "106810940377182887408",
    "onboardingStatus": "approved",
    "onboardingStartedAt": "2025-11-01T00:00:00Z",
    "onboardingCompletedAt": "2025-11-01T00:00:00Z",
    "trustLevel": "platinum",
    "trustScore": 100.00,
    "performanceMetrics": {"totalOrders": 0, "totalRevenue": 0, "onTimeShipmentRate": 100, "orderFulfillmentRate": 100, "returnProcessingTime": 24, "customerSatisfactionScore": 5},
    "complianceStatus": {"termsAccepted": true, "taxDocumentsSubmitted": true, "dataProcessingAgreementSigned": true},
    "suspensionHistory": [],
    "tierProgressionHistory": [{"from": "new", "to": "platinum", "reason": "Platform owner - official Ring Portal Store"}],
    "notes": "Official Ring Portal Store - Platform owner verified vendor"
  }'::jsonb,
  NOW(),
  NOW()
...
-- Product 1: High-availability project hosting
...
VALUES (
  ...
  '{
    ...
    "category": "hosting",
    "images": [
      "/images/store/k8s-hosting-main.jpg",
      "/images/store/k8s-dashboard.jpg",
      "/images/store/monitoring-grafana.jpg"
    ],
    "status": "active",
...
-- Product 2: HP Proliant DL360 1U Server
INSERT INTO store_products (id, data, created_at, updated_at)
VALUES (
  'prod_hp_dl360_server',
  '{
    "name": "HP Proliant DL360 1U Server",
    "slug": "hp-proliant-dl360-server",
    "description": "Enterprise-grade HP Proliant DL360 Gen9 servers shipped directly from our Phoenix warehouse to your datacenter worldwide",
    ...
    "category": "hardware",
    "images": [
      "/images/store/hp-dl360-front.jpg",
      "/images/store/hp-dl360-rear.jpg",
      "/images/store/hp-dl360-ilo.jpg"
    ],
    "status": "active",
    "vendorId": "vendor_ring_portal_store",
    "vendorName": "Ring Portal Store",
...
-- Product 3: Ring Instructor Course
INSERT INTO store_products (id, data, created_at, updated_at)
VALUES (
  'prod_ring_instructor_course',
  '{
    ...
    "category": "education",
    "images": [
      "/images/store/ring-course-preview.jpg",
      "/images/store/course-curriculum.jpg",
      "/images/store/course-materials.jpg"
    ],
    "status": "active",
    "vendorId": "vendor_ring_portal_store",
    "vendorName": "Ring Portal Store",
