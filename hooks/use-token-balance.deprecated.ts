...
//   // Native POL balance
//   const { data: polBalance, isLoading: polLoading, refetch: refetchPol } = useReadContract({
//     address: address as `0x${string}`,
//     abi: ERC20_ABI,
//     functionName: 'balanceOf',
//     args: address ? [address as `0x${string}`] : undefined,
//     query: {
//       enabled: !!address && isConnected && !!WPOL_ADDRESS,
//     },
//   })
...
//     POL: polBalance ? formatUnits(polBalance as bigint, 18) : '0',
