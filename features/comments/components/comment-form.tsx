...
import { useFormAction } from '@/features/forms/hooks/use-form-action'
...
import { createComment, CommentActionState } from '@/app/_actions/comments'
...
function CommentFormComponent({
  ...
  const { state, formAction } = useFormAction<CommentActionState | null, typeof createComment>(createComment)
