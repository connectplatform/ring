          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href={ROUTES.ENTITIES(locale)} className="hover:text-primary transition-colors">
                  {t('entities')}
                </Link></li>
                <li><Link href={ROUTES.OPPORTUNITIES(locale)} className="hover:text-primary transition-colors">
                  {t('opportunities')}
                </Link></li>
                <li><Link href={ROUTES.CONTACT(locale)} className="hover:text-primary transition-colors">
                  {t('contacts')}
                </Link></li>
                <li><Link href={ROUTES.DOCS(locale)} className="hover:text-primary transition-colors">
                  {t('documentation')}
                </Link></li>
              </ul>
            </div>
        ...
        <div className="container mx-auto px-4 lg:px-6 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4">
              <Link href={ROUTES.PRIVACY(locale)} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                {t('privacyPolicy')}
              </Link>
              <Link href={ROUTES.TERMS(locale)} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                {t('termsOfService')}
              </Link>
            </div>
          </div>
