/**
 * Agricultural ERP field catalogs (heavy — 29 producer types, 40-85 fields each).
 * Loaded ONLY via dynamic import (loadErpEntityTypes) — never import statically
 * from client modules or presets/index sync path.
 */

import type { EntityTypeCatalog } from './types'
...
export const erpEntityTypes = AGRICULTURAL_ENTITY_TYPES as unknown as EntityTypeCatalog
