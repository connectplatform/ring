...
Listen on Tunnel topic channels — see [Realtime transport](./real-time) and [Tunnel protocol](../features/tunnel-protocol).
...
<Cards>
  ...
  <Card title="Opportunities API" href="/docs/api/opportunities">
    REST surface + post-mutation hooks.
  </Card>
  <Card title="Entities API" href="/docs/api/entities">
    REST surface + post-mutation hooks.
  </Card>
</Cards>
