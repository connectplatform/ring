...
<RelatedDocs>
  <RelatedArticle
    ...
    relation="Depends-on: after transferNative / ensure, conductor fans out `wallet:list` via publishWalletListUpdate."
  />
  <RelatedArticle
    slug="features/wallet-conductor"
    relation="Next-step: dual-audience product guide for operators."
  />
  <RelatedArticle
    slug="architecture/payment-conductor"
    relation="Same-workflow: PSP ledger and webhooks for wallet_topup / native_token_onramp."
  />
  <RelatedArticle
    slug="features/wallet"
    relation="See-also: member-facing wallet dashboard flows."
  />
  <RelatedArticle
    slug="api/wallet"
    relation="Deep-dive: Server Actions and HTTP inventory."
  />
</RelatedDocs>
