...
<RingWidgetFlowStepsFive
  locale="en"
  title="PaymentConductor Orchestration"
  subtitle="Conductor actively orchestrates payment operations across gateways and handlers"
  centerLabel="PaymentConductor"
  centerIcon="Zap"
  centerColor="from-amber-500 to-orange-600"
  spokes={[
    { label: "UI/Checkout", icon: "ShoppingCart", color: "#10b981", description: "User initiates payment" },
