...
**Operator setup:** [Payment integration](/docs/customization/payment-integration) · [WayForPay](/docs/features/wayforpay-integration) · [Public Pools](/docs/features/public-pools)
...
<Cards>
  ...
  <Card title="Public Pools & DAO Jars" href="/docs/features/public-pools">
    `public_pool_contribution` + desk-oracle FX (not 1:1)
  </Card>
...
<RelatedDocs>
  <RelatedArticle
    ...
    relation="Depends-on: custodial native + credit facade used after settle and builder payout."
  />
  <RelatedArticle
    slug="features/public-pools"
    relation="Same-workflow: public_pool_contribution purpose, desk FX, and jar settle handler."
  />
  <RelatedArticle
    slug="features/payment-conductor"
    relation="Next-step: operator-facing Conductor purposes and rails."
  />
  <RelatedArticle
    slug="customization/payment-integration"
    relation="Prerequisite: PSP dashboards and env before enabling card jars."
  />
  <RelatedArticle
    slug="features/payments"
    relation="See-also: user-facing payment flows overview."
  />
  <RelatedArticle
    slug="api/admin"
    relation="See-also: admin user Payments tab endpoint."
  />
</RelatedDocs>
