...
Optional **Tunnel** realtime may use Supabase (`NEXT_PUBLIC_TUNNEL_TRANSPORT=supabase`) regardless of `DB_BACKEND_MODE`; see [Tunnel protocol](/en/docs/features/tunnel-protocol).
