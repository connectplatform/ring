...
Review UI lives at **`/admin/crm/*`** (`CrmAdminShell`). API paths stay `/api/admin/email/*` — see [Email AI-CRM](/docs/features/email-ai-crm) and [Owner Project Lab](/docs/features/owner-project-lab).
</Callout>
