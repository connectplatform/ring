...
- **Auth.js sessions** — JWT strategy server-side; browser receives **httpOnly session cookie**
...
*Need help with authentication? Check our [Getting Started](/en/docs/getting-started) guide.*
