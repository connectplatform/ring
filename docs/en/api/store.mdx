...
Checkout flows through **PaymentConductor** (`store_order` purpose): WayForPay/Stripe redirect, **internal credit** (`POST /api/store/payments/credit`), optional RING token rail. See [PaymentConductor](/docs/features/payment-conductor).
</Callout>
