...
<RelatedDocs title="Related">

<RelatedArticle
  slug="features/manage-via-telegram"
  relation="Same-workflow: phone-side admin bot for the same clone ops surface."
/>

<RelatedArticle
  slug="development/community-tooling"
  relation="See-also: kingdom MCP vs per-clone ring-mcp scope."
/>

<RelatedArticle
  slug="development/generative-videos"
  relation="Deep-dive: ring-video-create end-to-end on the clone."
/>

<RelatedArticle
  slug="features/admin-wiki"
  relation="Next-step: ring-wiki-* tools for project knowledge self-build and search."
/>

<RelatedArticle
  slug="development/docs-components"
  relation="See-also: MDX authoring reference including RelatedArticle."
/>
