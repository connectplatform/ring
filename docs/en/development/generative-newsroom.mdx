...
Reuses `XAI_API_KEY` and `XAI_API_BASE_URL` from [Generative images](/en/docs/development/generative-images).
...
Also requires [ImageConductor env](/en/docs/development/generative-images#environment) for featured images and ring-filebase for uploads.
...
*See also: [News module](/en/docs/features/news) · [Ring MCP](/en/docs/development/ring-mcp) · [Generative images](/en/docs/development/generative-images)*
