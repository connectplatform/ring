...
Types: `info` | `tip` | `success` | `warning` | `error` | `development` | `financing`. Optional `title`. Unknown types fall back to `info`. **Live gallery:** [Doc System](/docs/features/doc-system).
