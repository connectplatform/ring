...
Point each clone `.env.local` `DATABASE_URL` at its database (`ring_platform`, `ring_zemna_ai`, `ring_ringdom_org`, …). See [Database migrations](/docs/getting-started/migrations) and `infrastructure/postgres/MIGRATION-KINGDOM-MATRIX.md`.
...
- [Development Workflow](/en/docs/development/workflow) - Git workflow and best practices
- [Testing](/en/docs/development/testing) - Writing and running tests

---

*Need help? Join our [Discord Community](https://discord.gg/ring-platform) or check the [troubleshooting guide](/en/docs/getting-started/troubleshooting).*
