...
<Cards>
  <Card href="/docs/features/notifications" title="Notifications" description="Overview of notification types, channels, and preferences — includes GAME_REQUEST / GAME_UPDATED." />
  <Card href="/docs/features/peer-games" title="Peer Games" description="createInvite FCM GAME_REQUEST after ~500ms Tunnel presence grace when peer still offline." />
  <Card href="/docs/api/notifications" title="Notifications API" description="FCM register/unregister endpoints and realtime tunnel delivery." />
