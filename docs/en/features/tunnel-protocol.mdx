...
<FutureFeatureWidget
  ...
  description="Shipped 1.97.15 (default off): PostgresFanoutTunnelHub via TUNNEL_POSTGRES_FANOUT=enabled. Leave replicas at 1 until enabled + smoked; Redis/Connect hubs remain backlog."
