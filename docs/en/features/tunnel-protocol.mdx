...
**v1.6.0:** `lib/tunnel/disconnected-tunnel-context.ts` preserves UX when the tunnel is offline; pair with [Push notifications FCM](/docs/features/push-notifications-fcm) for mobile alerts.
