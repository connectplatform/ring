...
description: Auth.js v5 with slim proxy, layout-level protection, client login redirect, and Resend magic links (v1.6.4)
...
OAuth and Google One Tap use `/api/auth/*` (excluded from intl middleware). See [Proxy and intl](/docs/architecture/proxy-and-intl).
