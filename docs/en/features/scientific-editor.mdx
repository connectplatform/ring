...
Editor UI copy lives in `locales/{en,uk,ru}/editor.json` and loads through `next-intl` (`useTranslations('editor.*')`). Routing uses standard Ring locale config — see [Locale system](/docs/features/locale-system).
