...
<RelatedDocs>
  <RelatedArticle
    ...
    relation="Depends-on: Wagmi v3 + viem WalletClient, getEvmRpcUrl / getEvmTokenAddress SSOT."
  />
  <RelatedArticle
    slug="features/wallet"
    relation="Same-workflow: custodial balances and credit ledger alongside on-chain stakes."
  />
</RelatedDocs>
