...
> **Deep dives:** [Referral codes (refcodes)](/docs/features/refcodes) · [Refcodes architecture](/docs/architecture/refcodes) · [ERP commissions](/docs/features/erp/commissions)
...
<Card title="Referrer dashboard" href="/docs/features/refcodes">
  `/refcodes` — share links, reward history, visit stats (total / today / 7d / 28d).
</Card>

<Card title="Admin refcodes" href="/docs/features/refcodes">
  `/admin/refcodes` — approve fiat rewards, batch mint, platform visit aggregates.
</Card>

<Card title="Admin commissions" href="/docs/features/erp/commissions">
  `/admin/store/commissions` — settlement ledger, referral breakdown, process due payouts.
</Card>

<Card title="Architecture" href="/docs/architecture/refcodes">
...
<RelatedDocs>
  <RelatedArticle
    ...
    relation="Deep-dive: user/admin UI, contract deploy, and env vars for token rewards."
  />
  <RelatedArticle
    slug="features/erp/commissions"
    relation="Same-workflow: vendor-funded settlement hierarchy and payout modes."
  />
  <RelatedArticle
    slug="features/erp/inventory"
    relation="Depends-on: paid commitSaleForOrder runs beside settlement on store orders."
  />
  <RelatedArticle
    slug="features/payment-conductor"
    relation="Prerequisite: webhooks and orderReference contract."
  />
  <RelatedArticle
    slug="features/store"
    relation="Prerequisite: checkout and vendor flows feed referred orders."
  />
</RelatedDocs>
