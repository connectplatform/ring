...
| `features/generative-media/*` | Gallery SSOT; mint metadata helpers; see [Generative Gallery](/docs/features/generative-media) |
...
<Cards>
  <Card title="Generative Gallery" href="/docs/features/generative-media">
    Upload \| Generate field, credits billing, Metaplex metadata, product form reuse.
  </Card>
