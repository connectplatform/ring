...
<RelatedDocs title="Related reading">

<RelatedArticle
  slug="features/member-blog"
  relation="Same-workflow: member blogs share public article surfaces with news."
/>

<RelatedArticle
  slug="architecture/news-kingdom"
  relation="Deep-dive: promotion, Telegram, and News Kingdom migrations."
/>

<RelatedArticle
  slug="development/generative-newsroom"
  relation="Next-step: generative newsroom tooling on the same clone."
/>

<RelatedArticle
  slug="features/scientific-editor"
  relation="See-also: publications TipTap — not the news HTML editor."
/>

<RelatedArticle
  slug="architecture/real-time"
  relation="Depends-on: Tunnel / future CRDT collab channels for news."
/>

<RelatedArticle
  slug="features/admin-wiki"
  relation="See-also: Admin Wiki is Markdown + wikilinks in Postgres — not TipTap news HTML."
/>
