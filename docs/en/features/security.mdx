...
**Passwordless email** uses own SMTP via `lib/mailer.ts` — not Resend. See [Ring Mailer](/docs/features/ring-mailer).

<Code language="typescript" title="Ring Mailer shape (see auth.ts)">
