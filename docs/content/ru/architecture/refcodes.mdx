...
> **EN canonical:** полная диаграмма и роли контракта — [Refcodes architecture (EN)](/docs/library/architecture/refcodes)
...
- [Refcodes (функция)](/docs/library/features/refcodes)
- [PaymentConductor](/docs/library/architecture/payment-conductor)
- [ERP комиссии](/docs/library/features/erp/commissions)
