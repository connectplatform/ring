...
> **EN canonical:** полные диаграммы, контракт, deploy и таблицы env — [Referral Codes (EN)](/docs/library/features/refcodes) · [Архитектура refcodes](/docs/library/architecture/refcodes)
...
| ERP | Та же иерархия % комиссии, что и в [комиссиях ERP](/docs/library/features/erp/commissions) |
...
- [Ring ERP — комиссии](/docs/library/features/erp/commissions)
