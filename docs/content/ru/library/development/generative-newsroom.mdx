...
Требуются `XAI_API_KEY`, [ImageConductor env](/docs/library/development/generative-images) и ring-filebase.
...
- Полная EN-документация (JSON-схема, категории, security): [Autonomous newsroom](/docs/library/development/generative-newsroom) (локаль EN)
...
- [Новости](/docs/library/features/news)
