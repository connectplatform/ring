...
**Ring CLI** (`ring`) не в публичном репозитории. См. [Community tooling](/docs/library/development/community-tooling).
...
1. **[Authentication Examples](/ru/library/examples/authentication)** - Explore advanced auth patterns
2. **[API Integration](/ru/library/examples/api-integration)** - Deep dive into API usage
3. **[Web3 Integration](/ru/library/examples/web3-integration)** - Advanced blockchain features
4. **[Real World Apps](/ru/library/examples/real-world)** - Complete application examples

---

*Need help? Join our [Discord Community](https://discord.gg/ring-platform) or check the [API Documentation](/ru/library/api).*