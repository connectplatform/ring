...
<Callout type="info">
  **Нужна помощь с внедрением?** Смотрите [возможности кастомизации Ring](/opportunities?type=ring_customization) или [интеграцию платежей](/docs/library/customization/payment-integration) для fiat + token checkout.
</Callout>
