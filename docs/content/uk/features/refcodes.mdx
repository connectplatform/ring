...
> **EN canonical:** повні діаграми, контракт, deploy і таблиці env — [Referral Codes (EN)](/docs/library/features/refcodes) · [Архітектура refcodes](/docs/library/architecture/refcodes)
...
| ERP | Та сама ієрархія `%` комісії, що й у [комісіях ERP](/docs/library/features/erp/commissions) |
...
- [Ring ERP — комісії](/docs/library/features/erp/commissions)
