...
- **Push Notifications (FCM)** — Веб- та мобільні push через Firebase Cloud Messaging: повне налаштування, реєстрація токенів через Server Action та контракт API — див. [Push-сповіщення через FCM (Ring)](/library/features/push-notifications-fcm).
...
**[Push-сповіщення через FCM (Ring)](/library/features/push-notifications-fcm)**
