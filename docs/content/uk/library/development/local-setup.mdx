...
- **Node.js 20+** (22 рекомендовано) - [Завантажити з nodejs.org](https://nodejs.org/)
...
Після `install.sh` застосуйте [міграції БД](/docs/library/getting-started/migrations) для PostgreSQL.
