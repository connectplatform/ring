...
{`export default function TenantOverview({ params }) {
      ...
      return (
        <div className="space-y-6">
          <UiCard>
            <UiCardHeader>
              <UiCardTitle>{tenant.name}</UiCardTitle>
              <UiCardDescription>{tenant.domain}</UiCardDescription>
            </UiCardHeader>
            <UiCardContent>
...
export default function TenantAdmin() {
      ...
      return (
        <div className="space-y-6">
          ...
          <UiCard>
            <UiCardTitle>Брендинг</UiCardTitle>
            <UiCardContent>
              <LogoUploader />
              <ColorPicker />
            </UiCardContent>
          ...
          <UiCard>
            <UiCardTitle>Користувачі</UiCardTitle>
            <UiCardContent>
              <UserManagement />
            </UiCardContent>
          </UiCard>
...
{`export function UsageDashboard() {
      ...
      return (
        <div className="grid grid-cols-3 gap-4">
          ...
          <UiCard>
            <UiCardTitle>Сховище</UiCardTitle>
            <UiCardContent>
              <ProgressBar
          ...
          <UiCard>
            <UiCardTitle>API виклики</UiCardTitle>
            <UiCardContent>
              <ProgressBar
