...
PostgreSQL schema + kingdom migrations — see [Migrations](/docs/library/getting-started/migrations).
...
These steps apply only to **enterprise** checkouts that include `cli/`. Community developers should use [Self-hosted deployment](/docs/library/deployment/self-hosted).
