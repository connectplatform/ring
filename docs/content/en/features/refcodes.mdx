...
<Callout type="info" title="Dual-rail context">
  Token rewards (this module) run alongside **vendor-funded ERP referral commission** on the same attribution. See [Affiliate & referral enablement](/docs/library/features/affiliate-enablement) for the full dual-rail map and audit keys.
</Callout>

> **Architecture:** [Refcodes architecture](/docs/library/architecture/refcodes) · **Dual-rail overview:** [Affiliate enablement](/docs/library/features/affiliate-enablement) · **Migrations:** [Getting started: migrations](/docs/library/getting-started/migrations) · **Clone install:** `scripts/install-refcodes-module.sh`
...
| **ERP rail** | Same `resolveReferralCommissionPercent` hierarchy deducts vendor commission — see [ERP commissions](/docs/library/features/erp/commissions) |
...
- [Affiliate & referral enablement](/docs/library/features/affiliate-enablement) — dual-rail economics and audit
- [Ring ERP — Commissions](/docs/library/features/erp/commissions)
- [Multi-Vendor Store](/docs/library/features/store)
- [Payment Integration](/docs/library/features/payments)
- [PaymentConductor](/docs/library/features/payment-conductor)
- [Web3 Wallet](/docs/library/features/wallet)
