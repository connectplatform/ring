...
- **Push Notifications (FCM)** - Web and mobile push via Firebase Cloud Messaging; see [Push Notifications with FCM (Ring-Powered)](/library/features/push-notifications-fcm) for full setup, Server Action token registration, and API contract.
...
**[Push Notifications with FCM (Ring-Powered)](/library/features/push-notifications-fcm)**
