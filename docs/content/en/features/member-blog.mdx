...
Member posts can be promoted to the main news feed with kingdom fields (`promoteToMainPage`, `mainPageStatus`, payment via PaymentConductor). See [News Kingdom](/docs/library/architecture/news-kingdom).
...
- [News module](/docs/library/features/news)
