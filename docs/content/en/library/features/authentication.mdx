...
description: Auth.js v5 with slim proxy, layout-level protection, and Resend magic links (v1.6.0)
...
OAuth and Google One Tap use `/api/auth/*` (excluded from intl middleware). See [Proxy and intl](/docs/library/architecture/proxy-and-intl).
