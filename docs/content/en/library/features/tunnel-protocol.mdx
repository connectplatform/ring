...
description: Multi-transport realtime with disconnected-tunnel-context and FCM push (v1.6.0)
...
**v1.6.0:** `lib/tunnel/disconnected-tunnel-context.ts` preserves UX when the tunnel is offline; pair with [Push notifications FCM](/docs/library/features/push-notifications-fcm) for mobile alerts.
