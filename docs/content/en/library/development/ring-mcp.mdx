...
| Package | Path | Role |
|---------|------|------|
| **ring-mcp** | `AI-RING/ring-mcp/` | stdio MCP server, 57 `ring-*` tools |
...
**Full reference:** [Autonomous newsroom (generative-newsroom)](/en/library/development/generative-newsroom) — parameters, Telegram flow, translation fan-out, env block, troubleshooting.
...
**Full reference:** [Generative images (generative-images)](/en/library/development/generative-images) — providers, OG presets, env block, `GenerateImageDialog`, migration `006_generated_images_schema.sql`.
