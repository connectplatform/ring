...
<Callout type="info">
  **Dual-rail:** Token minting (this document) pairs with ERP `settlements` referral commission on the same `orderReference`. Overview: [Affiliate enablement](/docs/library/features/affiliate-enablement).
</Callout>
...
- [Feature: Referral Codes](/docs/library/features/refcodes)
- [Affiliate enablement](/docs/library/features/affiliate-enablement) — dual-rail audit and operator checklist
- [ERP commissions](/docs/library/features/erp/commissions) — vendor-funded rail
- [PaymentConductor architecture](/docs/library/architecture/payment-conductor)
- [Proxy and i18n](/docs/library/architecture/proxy-and-intl)
