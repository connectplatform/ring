...
description: Документація автентифікації для платформи Ring
---
  ...
  return (
    <ProtectedRoute requiredRole="admin">
      <div className="container mx-auto p-8">
        ...
        <div>Only admins can see this content.</div>
      </div>
    </ProtectedRoute>
  )
}`}
...
---
*Готові до більшого? Перегляньте [Інтеграція API](/uk/docs/examples/api-integration) або [Web3 Інтеграція](/uk/docs/examples/web3-integration).*
