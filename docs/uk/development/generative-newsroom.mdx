...
Потрібні `XAI_API_KEY`, [ImageConductor env](/docs/development/generative-images) і ring-filebase.
...
- Повна EN-документація (схема JSON, категорії, security): [Autonomous newsroom](/docs/development/generative-newsroom) (локаль EN)
- [Генеративні зображення](/docs/development/generative-images)
- [Ring MCP](/docs/development/ring-mcp) — `ring-news-generate`
- [Новини](/docs/features/news)
