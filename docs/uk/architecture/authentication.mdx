...
| **Magic Links** | Email через Resend, 24-годинний термін дії токену | `Resend` |
...
Потребує `AUTH_RESEND_KEY` змінну середовища та активний адаптер бази даних (для зберігання токенів):
