...
> **EN canonical:** повна діаграма та ролі контракту — [Refcodes architecture (EN)](/docs/architecture/refcodes)
...
- [Refcodes (функція)](/docs/features/refcodes)
- [PaymentConductor](/docs/architecture/payment-conductor)
- [ERP комісії](/docs/features/erp/commissions)
