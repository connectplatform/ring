...
Платформа Ring NFT маркетплейс дозволяє автентифікованим учасникам створювати лістинги NFT, переглядати колекції та виконувати безпечні блокчейн транзакції, демонструючи свої NFT колекції через публічні профілі за адресою `/[locale]/[username]` (наприклад, `/uk/johndoe`).
...
**Сторінки Профілів Користувачів** за адресою `/[locale]/[username]`
// Структура маршрутів публічного профілю (Next.js 16 App Router)

<Code language="typescript" title="TypeScript">
{`/[locale]/[username]  // наприклад, /uk/johndoe`}
</Code>
