...
- **Push Notifications (FCM)** — Веб- и мобильные push через Firebase Cloud Messaging: полная настройка, регистрация токенов через Server Action и контракт API — см. [Push-уведомления через FCM (Ring)](/docs/features/push-notifications-fcm).
...
**[Push-уведомления через FCM (Ring)](/docs/features/push-notifications-fcm)**
