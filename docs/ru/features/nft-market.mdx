...
Платформа Ring NFT маркетплейс позволяет аутентифицированным участникам создавать листинги NFT, просматривать коллекции и выполнять безопасные блокчейн транзакции, демонстрируя свои NFT коллекции через публичные профили по адресу `/[locale]/[username]` (например, `/ru/johndoe`).
...
**Страницы Профилей Пользователей** по адресу `/[locale]/[username]`
// Структура маршрутов публичного профиля (Next.js 16 App Router)

<Code language="typescript" title="TypeScript">
{`/[locale]/[username]  // например, /ru/johndoe`}
</Code>
