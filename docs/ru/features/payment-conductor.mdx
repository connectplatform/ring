...
lib/payments/conductor/payment-conductor.ts
        ↓
Процессоры: wayforpay | stripe | credit_balance
        ↓
...
- [Обзор платежей](/docs/features/payments)
- [WayForPay](/docs/features/wayforpay-integration)
- [Архитектура PaymentConductor](/docs/architecture/payment-conductor)
