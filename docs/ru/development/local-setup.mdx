...
После `install.sh` примените [миграции БД](/docs/getting-started/migrations) для PostgreSQL.
...
- [Development Workflow](/ru/docs/development/workflow) - Git workflow and best practices
- [Testing](/ru/docs/development/testing) - Writing and running tests

---

*Need help? Join our [Discord Community](https://discord.gg/ring-platform) or check the [troubleshooting guide](/ru/docs/getting-started/troubleshooting).*
