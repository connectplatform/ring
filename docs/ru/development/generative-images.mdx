...
- Полная EN-документация (таблицы полей, troubleshooting): [Generative images](/docs/development/generative-images) (локаль EN)
- [Автономная редакция](/docs/development/generative-newsroom) — featured image для статей
- [Ring MCP](/docs/development/ring-mcp) — `ring-image-create`
