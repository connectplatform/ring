...
/** Build pathname for /[username]/[slug] (no locale prefix). */
function profileArticlePathname(username: string, slug: string): string {
...
export async function generateMetadata({
  ...
  if (!article) {
    return buildLocalizedMetadata({
      locale,
      path: 'blog.article',
      pathname: profileArticlePathname(username, slug),
