 ...
 * 
 * The container that portals the sheet content outside of the current DOM hierarchy.
 */
 ...
 * 
 * The overlay that covers the inert portion of the view when the sheet is open.
 * 
 * @param className - Additional CSS classes to apply to the overlay
 * @param props - Additional props to pass to the overlay
 */
 ...
 * Sheet variants
 * 
 * Defines the different positions and animations for the sheet.
 */
 ...
 * @param props - Additional props to pass to the content
 */
 ...
 * @param props - Additional props to pass to the header
 */
const SheetHeader = ({
  className,
  ...props
 ...
 * @param props - Additional props to pass to the footer
 */
const SheetFooter = ({
  className,
  ...props
 ...
 * @param props - Additional props to pass to the title
 */
 ...
 * @param props - Additional props to pass to the description
 */
